...
The following example will read in data projecting the 2014 statistics for NFL players.  These values can be used to generate how much players are worth for a fantasy football league.  The CSV files are actually tab-delimited (there's probably a lesson here on examining your raw data before reading it into R).
...
x3[,'value'] <- x3[,'marg']*(12*200-nrow(x))/sum(x3[,'marg']) + 1
